            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <?php if (has_role("Admin")) : ?>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="<?php echo get_url('admin/create_realty.php'); ?>">Create Realty</a></li>
                            <li><a class="dropdown-item" href="<?php echo get_url('admin/list_realty.php'); ?>">List Realty</a></li>
                        </ul>
                    </li>
                <?php endif; ?>
                <?php if (is_logged_in()) : ?>
